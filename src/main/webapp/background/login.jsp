...
<div class="logintop">    
    ...
    <form action="${pageContext.request.contextPath}/userlogin" method="post">
        <ul>
            <li><input name="uid" type="text" class="loginuser" value="1" onclick="JavaScript:this.value=''"/></li>
            <li><input name="upwd" type="password" class="loginpwd" value="1" onclick="JavaScript:this.value=''"/></li>
